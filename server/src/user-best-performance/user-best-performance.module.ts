...
import { UserBestPerformance, UserBestPerformanceSchema } from './model/user-best-performance.model';
...
@Module({
  imports: [MongooseModule.forFeature([{ name: UserBestPerformance.name, schema: UserBestPerformanceSchema }])],
